...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style(
			...
			filemtime( get_template_directory() . '/inc/customizer/controls/alpha-color-picker/alpha-color-picker.css' ),
		);
		...
		wp_enqueue_script(
			...
			filemtime( get_template_directory() . '/inc/customizer/controls/alpha-color-picker/alpha-color-picker.js' ),
			array(
				'in_footer' => false,
				'strategy'  => 'defer',
			)
